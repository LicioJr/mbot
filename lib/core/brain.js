...
let _modules = {};
let _states = {}; // dialog state dictionary by user key
...
function init(cfg, cb) {
    ...
    _cfg.admin = _cfg.admin || {};
    _cfg.admin.users = _cfg.admin.users || [];
    _cfg.admin.command = _cfg.admin.command || {};
    _cfg.admin.command.quit = _cfg.admin.command.quit || 'quit';

    _cfg.global = _cfg.global || {};
    _cfg.global.command = _cfg.global.command || {};
    _cfg.global.command.help = _cfg.global.command.help || 'help';

    _cfg.message = _cfg.message || {};
    _cfg.message.welcome = _cfg.message.welcome || '[core.brain.message.welcome]';
    _cfg.message.unknown = _cfg.message.unknown || '[core.brain.message.unknown]';
    _cfg.message.refine = _cfg.message.refine || '[core.brain.message.refine]';
    _cfg.message.error = _cfg.message.error || '[core.brain.message.error]';
...
function reply(ii, cb) {
    // check required Input Information
    ii = ii || {};
    if (!ii.from || !ii.text)
        return cb(null, {
    ...
    _states[ii.from] = _states[ii.from] || {};

    // bots interface
    let dialog = {
        from: ii.from,
        text: ii.text,
        state: _states[ii.from],
        action: '',
        entities: [],
        nonEntities: []
    }
